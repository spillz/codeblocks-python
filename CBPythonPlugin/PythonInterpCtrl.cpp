...
#ifdef __WXMSW__
    wxString cmd=_T("c:\\python25\\pythonw interp.py ")+wxString::Format(_T(" %i"),m_port); //TODO: this could have process destruction issues on earlier version of wxWidgets (kills cmd, but not python)
